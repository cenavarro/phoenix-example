...
#
#     PHX_SERVER=true bin/phoenix_example start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :phoenix_example, PhoenixExampleWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :phoenix_example, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :phoenix_example, PhoenixExample.Mailer,
