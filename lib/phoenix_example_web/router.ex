defmodule PhoenixExampleWeb.Router do
  ...
  scope "/", PhoenixExampleWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PhoenixExampleWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PhoenixExampleWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PhoenixExampleWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PhoenixExampleWeb do
    ...
    live_session :current_user,
      on_mount: [{PhoenixExampleWeb.UserAuth, :mount_current_user}] do
